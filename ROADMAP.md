...
#### Phase 1: The Core Engine ~~(Weekend 1: Sep 27-28)~~ Completed at Sep 27 09:20 PM
...
* **Tasks:**
    ...
    2. In `main.rs`, write the TUI boilerplate: enable raw mode, set up the `Terminal` with the `crossterm` backend, and
       create the main loop that draws to the screen and handles events.
...
* **Tasks:**
    1. Use `ratatui::layout::{Layout, Constraint, Direction}` to split your terminal screen into different rectangular
       areas.
